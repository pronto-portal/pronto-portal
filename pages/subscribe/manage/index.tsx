      ...
      >
        ...
        >
          ...
          >
            ...
            <FlexGridItemCenterItems>
              ...
              <Typography variant="body1">
                {role && role.name.toLowerCase() === "unlimited" ? (
                  ...
                  `${remainingTranslators} / ${translatorsLimit}`
                )}
              </Typography>
            </FlexGridItemCenterItems>
            <FlexGridItemCenterItems>
            ...
            <FlexGridItemCenterItems>
              ...
              <Typography variant="body1">
                {role && role.name.toLowerCase() === "unlimited" ? (
                  ...
                  `${remainingReminders} / ${remindersLimit}`
                )}
              </Typography>
            </FlexGridItemCenterItems>
            <FlexGridItemCenterItems>
            ...
            <FlexGridItemCenterItems>
              <Typography variant="body1" fontWeight="bold">
                {user && user.autoRenewSubscription
                  ? "Subscription ends on"
                  : "Subscription will auto-renew on"}
              </Typography>
              <Typography variant="body1">
                {user && user.subscriptionEndDate
                  ? moment(user.subscriptionEndDate).format("MMM Do, YYYY")
                  : "N/A"}
              </Typography>
            </FlexGridItemCenterItems>
            <FlexGridItemCenterItems>
            ...
            <FlexRowGridItem sx={{ justifyContent: "space-around", flex: 0.5 }}>
              ...
              <Button
                color={user && user.autoRenewSubscription ? "success" : "error"}
                variant="contained"
                onClick={() => setOpen(true)}
              >
                {`${
                  user && user.autoRenewSubscription ? "Enable" : "Disable"
                } Autorenewal`}
              </Button>
            </FlexRowGridItem>
          </Grid>
