...
type FilteredAddressesContextProps = FilteredObjects<GetAddressesFilter, GetAddresses>;

const FilteredAddressesContext = createContext<FilteredAddressesContextProps>({} as FilteredAddressesContextProps);
...
export const useFilteredAddresses = () => {
    ...
    if (!data) throw new Error('useFilteredAddresses must be used within FilteredAddressesProvider');
