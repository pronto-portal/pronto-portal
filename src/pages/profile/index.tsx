...
export default function Profile() {
    ...
    return (
        <Stack width='100%' height='100%' justifyContent='flex-start' direction='column' alignItems='center' padding={2}>
            {user && !isLoading ? (
                <Grid container width='60%' height='100%' direction='column' spacing={1} wrap='nowrap'>
                    <Grid item>
                    ...
                    <JustifiedBetweenGridItem>
                        ...
                        <Stack direction='row' spacing={1}>
                            {user.languages.map((language) => (
                                <Chip label={getLanguageFromCode(language)} key={`userProfileLanguage-${language}`} />
                            ))}
                        </Stack>
                    </JustifiedBetweenGridItem>
                    <FlexRowGridItem>
                    ...
                    <JustifiedBetweenGridItem>
                        ...
                        <Typography variant='body1'>{user.remindersCreatedThisMonth}</Typography>
                    </JustifiedBetweenGridItem>
                    <FlexRowGridItem>
                        <Divider sx={{ width: '100%' }} />
                    </FlexRowGridItem>
                    ...
                    <JustifiedBetweenGridItem>
                        ...
                        <Checkbox disabled={true} checked={user.isManager} sx={{ padding: 0 }} />
                    </JustifiedBetweenGridItem>
                    <FlexRowGridItem>
                        <Divider sx={{ width: '100%' }} />
                    </FlexRowGridItem>
                    <JustifiedBetweenGridItem>
                        ...
                        <Checkbox disabled={true} checked={user.isTranslator} sx={{ padding: 0 }} />
                    </JustifiedBetweenGridItem>
                </Grid>
            ) : (
                <CircularProgress />
