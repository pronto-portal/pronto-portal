...
import { Stack, Box, Typography, Grid, TextField, Autocomplete, Button, FormControl, FormControlLabel, FormLabel, RadioGroup, Radio } from '@mui/material';
...
import { useCompleteProfileMutation, useGetUserQuery } from '../../redux/reducers';
...
export default function CompleteProfile() {
    ...
    const isInputValid = firstName && lastName && city && state && isPhoneNumberValid;
    ...
    return (
        <Stack width='100%' height='100%' justifyContent='center' alignItems='center'>
            ...
            >
                <Grid container width='100%' height='100%' alignItems='center' justifyContent='center' direction='column' flexWrap='nowrap' rowGap={1}>
                    <Grid item xs={2}>
                    ...
                    <Grid item container xs={9} spacing={2} justifyItems='center' alignItems='center' justifyContent='start'>
                        <Grid item xs={6}>
                            <TextField
                                label='Phone *'
                        ...
                        <Grid item xs={6}>
                            <FormControl fullWidth>
                                ...
                                <RadioGroup row value={!!isTranslator ? 'yes' : 'no'} onChange={(e) => setIsTranslator(e.target.value === 'yes')}>
                        ...
                        <Grid item xs={6}>
                            <FormControl fullWidth>
                                ...
                                <RadioGroup row value={!!isManager ? 'yes' : 'no'} onChange={(e) => setIsManager(e.target.value === 'yes')}>
                                    <FormControlLabel value='yes' label='Yes' control={<Radio />} />
                                    <FormControlLabel value='no' label='No' control={<Radio />} />
                                </RadioGroup>
                            </FormControl>
                        ...
                        <Button
                            ...
                            onClick={() => {
                                saveChanges({
                                    ...
                                    isTranslator: isTranslator !== undefined ? isTranslator : false,
                                    languages,
                                    city,
                                    state,
                                }).then(() => {
