...
import { axiosInstanceCustomUrl } from '../../utils/axiosInstances';
            ...
            <button
                ...
                onClick={() => {
                    axiosInstanceCustomUrl
                        .get(`${process.env.NODE_ENV === 'production' ? 'https://prontotranslationservices.com' : 'http://localhost:3000'}/api/auth/google`)
                        .then((res) => {
