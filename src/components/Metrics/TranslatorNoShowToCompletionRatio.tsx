...
const TranslatorNoShowToCompletionRatio: React.FC = () => {
    ...
    const { data, isError, isLoading, isEmpty } = useTranslatorNoShowToCompletionRatio(sortBy);
        ...
        <MetricLoadingStates isError={isError} isLoading={isLoading} isEmpty={isEmpty}>
            <Stack direction='column' spacing={2} width='100%' height='100%' alignItems='center'>
                <Stack direction='row' justifyContent='center' alignItems='center' spacing={2}>
                    ...
                    <RangeSelectTabs onChange={setSortBy} options={['isComplete', 'translatorNoShow', 'claimantNoShow', 'total']} />
                </Stack>
                <ResponsiveBar
                    data={data || []}
